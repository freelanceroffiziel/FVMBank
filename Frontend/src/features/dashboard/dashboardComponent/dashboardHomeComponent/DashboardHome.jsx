      ...
      >
        ...
        >
          ...
          >
            <span>
              {" "}
              <RiDatabase2Fill className="text-[45px] md:text-[50px] lg:text-[35px] text-teal-600  " />
            </span>
            <p className="text-[22px] md:text-[25px] lg:text-[16px] font-semibold tracking-wide">
          ...
          >
            <span>
              {" "}
              <RiDatabaseFill className="text-[45px] md:text-[50px] lg:text-[35px] text-teal-600  " />
            </span>
            <p className="text-[22px] md:text-[25px] lg:text-[16px] font-semibold tracking-wide">
          ...
          >
            <span>
              <RiShareCircleFill className="text-[45px] md:text-[50px] lg:text-[35px] text-teal-600  " />
            </span>
            <p className="text-[22px] md:text-[25px] lg:text-[16px] font-semibold tracking-wide ">
              Transfer to another bank
            </p>
