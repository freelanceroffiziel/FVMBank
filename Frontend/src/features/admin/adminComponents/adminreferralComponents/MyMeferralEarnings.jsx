...
const MyMeferralEarnings = () => {
  return (
    <>
      <main>
        <section className="px-6 py-6 text-gray-100 bg-teal-800 rounded ">
          <div
            id=""
          ...
          >
            <p className="flex flex-row items-center gap-2  text-[28px] md:text-[22px] lg:text-[30px] font-semibold text-teal-600 ">
              My<p className="font-bold text-teal-600 ">Referrals</p>{" "}
                ...
                <span className="flex flex-row items-center gap-2">
                  <span className="flex flex-row items-center gap-2">
                    ...
                    <select
                      name="show"
                      id="show"
                      className="bg-teal-900 border-none rounded outline-none ring-1 ring-gray-400"
                    >
