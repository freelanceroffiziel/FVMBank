...
import { paymentjsonone } from "../adminComponents/dashboardjson/paymentjsonone";

const AdminPaymentMaquee = () => {
  return (
...
export default AdminPaymentMaquee;
